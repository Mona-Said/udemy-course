        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            image: const DecorationImage(
              image:NetworkImage('https://media.istockphoto.com/id/1065782416/photo/online-news-in-mobile-phone-close-up-of-smartphone-screen-man-reading-articles-in-application.webp?b=1&s=170667a&w=0&k=20&c=3sEfQJpggmkOhFRisDiwqO3GGDNnholVOmA15956ViE='),
              fit: BoxFit.cover,
            ),
          ),
        ),
              ...
              Row(
                ...
                [
                  ...
                  IconButton(
                    ...
                    icon: CircleAvatar(
                      radius: 15.0,
                      backgroundColor: (ShopCubit.get(context).favorites[model.id!] != null &&
                          ShopCubit.get(context).favorites[model.id!]!)? Colors.brown: Colors.white,
                      child: Icon(
                        Icons.favorite_border,
                        size: 15.0,
                        color: (ShopCubit.get(context).favorites[model.id!] != null &&
                            ShopCubit.get(context).favorites[model.id!]!) ? Colors.white : Colors.black,
                      ),
                    ),
                  ),
                ],
